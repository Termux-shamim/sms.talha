...
def update():
    try:
        ...
        toolVersion = "ToxicShamim"
    
    try:
        mainVersion = requests.get("https://www.facebook.com/white.hat.naca.hogar.shamim.12").text
    except:
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Toxic Shamim                 \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/Termux-Shamim\033[94m│".center(columns+9))
